<style>
  ...
  /* Style for the image to add a left margin */
  .untree_co--site-section img {
      margin-left: 20%; /* Add left margin of 20px to images */
  }
  ...
  .untree_co--site-section h2 {
      margin-left: 10%; /* Add left margin of 20px to images */
  }

  /* Style for the section containing the video and text */
  .untree_co--site-section.pt-0 {
      margin-top: 40px; /* Add top margin of 30px */
  }

  /* Optional: Add some padding to the section for better spacing */
    ...
    <div class="container">
      <div class="row align-items-end text-center">
        <div class="col-lg-7 mx-auto">
          <h1>Giới thiệu</h1>  
          <p class="mb-4"><a href="../index.php">Trang chủ</a> / <strong>Giới thiệu</strong></p>        
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="container-fluid px-md-0">
            ...
            <div class="row justify-content-center text-center pt-0 pb-5">  
              <div class="col-lg-6 section-heading" data-aos="fade-up">
                <h3 class="text-center">Aura Fashion Shop</h3>
              </div>
            </div>
