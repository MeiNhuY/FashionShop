  ...
  <main class="untree_co--site-main">
          ...
          <div class="container-fluid px-md-0">
            ...
            <div class="row no-gutters">
              <div class="col-md-4"  data-aos="fade-up">
                 <img src="../public/images/page/mau1.jpg" alt="Image" class="img-fluid" data-jarallax-element="-140">
              </div>
              <div class="col-md-8">
                <div class="row justify-content-center">
                  <div class="col-md-10">
                    <h2 class="mb-4" data-aos="fade-up">Philosophy</h2>
                    <div class="row">
        ...
        <div class="untree_co--site-section pt-0">
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-12">
                <img src="../public/images/page/mau1.jpg" alt="Image" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
